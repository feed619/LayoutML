...
`CSSInline` - это специализированный класс, наследующий от CSSBase, предназначенный для генерации inline стилей HTML элементов. Класс предоставляет удобный способ создания строки CSS стилей в формате, пригодном для вставки в HTML атрибут style.
...
CSSInline наследует все методы и свойства от родительского класса CSSBase, добавляя специализированный функционал для рендеринга inline стилей.
