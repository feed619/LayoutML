...
## Основные возможности
    ...
    Цепочное добавление стилей через [CSSBase](CSSBase.md)
...
Словарь, содержащий все созданные селекторы. Ключи - имена селекторов, значения - экземпляры [CSSBase](CSSBase.md).
