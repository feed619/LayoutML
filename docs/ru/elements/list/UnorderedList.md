...
`UnorderedList` - это специализированный класс для создания HTML маркированных (ненумерованных) списков <ul>. Класс наследуется от [ListElement](ListElement.md) и предназначен для создания списков, где порядок элементов не имеет значения (например, списки товаров, меню, категории, характеристики).
...
- Родительский класс: [ListElement](ListElement.md)
